<template>
    <modal :name="'confirm-delete-reply-'+id" classes="p-8 bg-gray-100 shadow-lg rounded-lg w-64" height="auto"
           width="25%" @before-open="beforeOpen">
        ...
        <div class="flex items-center justify-center">
            <button
                ...
                @click="$modal.hide(`confirm-delete-reply-${id}`)">Cancel
            </button>
            ...
            <button
                ...
                type="button" @click="submit">Delete
            </button>
        </div>
    </modal>
</template>
