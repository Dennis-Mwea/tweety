        ...
        <div class="border border-gray-400 rounded-xl p-4 w-full">
            <div class="flex items-start">
                ...
                <div class="flex items-start flex-1 ml-1 mb-4">
                    <img src="{{ $notification->data['notifier']['avatar'] }}" alt="image"
                         class="h-6 w-6 rounded-full mb-1 mr-1"/>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime voluptates sequi adipisci quibusdam
                repellat ducimus. Laboriosam velit quaerat necessitatibus blanditiis!</p>
        </div>
    </div>
</div>
